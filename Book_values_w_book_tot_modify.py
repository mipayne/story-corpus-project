# -*- coding: utf-8 -*-
"""
Created on Fri Aug  5 09:21:19 2016

@author: Madelyn
"""
'''slight differences to book_values; values of removed_propnouns and removed_words
will be found on book_tot_modify but is not returned in the book_tot_modify function;
uses modified_book_words from book_tot_modify instead of using book_words for the
entire page
'''
...
modified_book_words = book_tot_modify.book_tot_modify('./resources/converted/StoryCorpus/*.txt')
